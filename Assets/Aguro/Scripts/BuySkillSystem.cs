...
public class BuySkillSystem : MonoBehaviour
{
    ...
    float[,] skillParameterTable = new float[3, 20] {
        //FIXME: パラメーター調整
        { 15, 25, 40, 60, 85, 115, 150, 190, 235, 285, 340, 400, 465, 535, 610, 690, 775, 865, 960, 1060},
        { 150, 250, 400, 600, 850, 1150, 1500, 1900, 2350, 2850, 3400, 4000, 4650, 5350, 6100, 6900, 7750, 8650, 9600, 10600},
